...
describe('Задача №2', () => {
  ...
  it('объект Triangle не должен менять свойства периметра и площади', () => {
    ...
    // Убираем попытки изменить свойства
    delete triangle.perimeter;
    delete triangle.area;
...
Теперь тесты должны проходить без ошибок, так как устранены две ключевые проблемы: сравнение чисел с плавающей точкой и защита свойств от изменения.
